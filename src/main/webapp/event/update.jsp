                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="${pageContext.servletContext.contextPath}/app/events/find/${bean.idEvent}">${bean.nom}</a>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <s:form modelAttribute="bean" id="form" action="${pageContext.servletContext.contextPath}/app/events/update/${bean.idEvent}/${bean}" method="POST" class="wizard-big">
                                        <h1>Evènement</h1>
                                        <fieldset>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <s:select name="recipe.idRecipe" path="recipe.idRecipe" class="form-control">
                                                            <c:forEach items="${listRecipes}" var="data">
                                                                <s:option name="recipe" value="${data.idRecipe}">${data.nom}</s:option>
                                                            </c:forEach>
                                                        </s:select>
                                                    </div>
                                                    <s:hidden name="organisateur.idUser" path="organisateur.idUser" value="${bean.organisateur.idUser}"/>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
