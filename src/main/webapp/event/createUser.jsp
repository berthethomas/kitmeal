...
<html>
    ...
    <head>
        ...
        <link href="${pageContext.servletContext.contextPath}/assets/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="${pageContext.servletContext.contextPath}/app/events/find/${idEvent}">Evènement</a>
                            </li>
                            <li class="active">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    <c:forEach items="${bean}" var="user">
                                        <div class="i-checks">
                                            <input type="checkbox" class="form-control users" value="${user.idUser}" id="${user.idUser}">
                                        </div>
                                        <label for="user${user.idUser}">${user.nom} ${user.prenom}</label>
                                    </c:forEach>
                                    <input id="validate" type="button" class="btn btn-success" value="Valider"/>
                                    <a href="${pageContext.servletContext.contextPath}/app/events/find/${idEvent}" class="btn btn-default">Retour à l'evènement</a>
                                </div>
                            </div>
                        </div>
            ...
            $("#validate").on('click', function () {
                $('.users').each(function () {
                    if ($(this).is(':checked')) {
                        ...
                        $.ajax({
                            url: '${pageContext.servletContext.contextPath}/app/events/create/users/${idEvent}',
                                                    type: 'POST',
                                                    dataType: 'html',
                                                    data: {
                                                        "idUser": idUser,
