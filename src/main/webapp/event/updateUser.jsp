                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    <c:forEach items="${bean}" var="val">
                                        <div class="i-checks">
                                            <input type="checkbox" class="form-control users" value="${val.user.idUser}" id="${val.user.idUser}">
                                        </div>
                                        <label for="user${val.user.idUser}">${val.user.nom} ${val.user.prenom}</label>
                                    </c:forEach>
            ...
            $("#validate").on('click', function () {
                $('.ingredients').each(function () {
                    if ($(this).is(':checked')) {
                        ...
                        $.ajax({
                            url: '${pageContext.servletContext.contextPath}/app/events/update/users/${idEvent}',
                                                    type: 'POST',
                                                    dataType: 'html',
                                                    data: {
                                                        "idUser": idUser,
