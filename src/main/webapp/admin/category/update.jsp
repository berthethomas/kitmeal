                        ...
                        <div class="col-lg-12">
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <s:form modelAttribute="bean" id="form" action="${pageContext.servletContext.contextPath}/app/categories/update/${bean.idCategory}/${bean}" method="POST" class="wizard-big">
                                        <h1>Catégorie</h1>
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-lg-12">
