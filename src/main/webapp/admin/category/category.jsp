            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-12">
                        ...
                        <a href="${pageContext.servletContext.contextPath}/app/categories/create" type="button" class="btn btn-w-m btn-primary pull-right"><i class="fa fa-plus-circle"></i> Ajouter une catégorie</a>
                    </div>
                </div>
                                            ...
                                            <c:forEach items="${bean}" var="item">
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="${pageContext.servletContext.contextPath}/app/categories/update/${item.idCategory}"><i class="fa fa-wrench"></i></a>
                                                        <a href="${pageContext.servletContext.contextPath}/app/categories/remove/${item.idCategory}"><i class="fa fa-times"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach> 
                                        </tbody>
