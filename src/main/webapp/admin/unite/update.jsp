                        ...
                        <div class="col-lg-12">
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <s:form modelAttribute="bean" id="form" action="${pageContext.servletContext.contextPath}/app/unites/update/${bean.idUnite}/${bean}" method="POST" class="wizard-big">
                                        <h1>Unité</h1>
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-lg-12">
