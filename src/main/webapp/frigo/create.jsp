                        ...
                        <div class="col-lg-12">
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <s:form modelAttribute="bean" id="form" action="${pageContext.servletContext.contextPath}/app/userIngredients/create/${bean}" method="POST" class="wizard-big">
                                        <h1>Ingrédients</h1>
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Unité</label>
                                                        <s:select name="unite.idUnite" path="unite.idUnite" class="form-control">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <s:select name="category.idCategory" path="category.idCategory" class="form-control">
