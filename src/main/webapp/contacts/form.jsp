                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="${pageContext.servletContext.contextPath}/app/users">Utilisateurs</a>
                            </li>
                            <li class="active">
                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <s:form modelAttribute="bean" id="form" action="${pageContext.servletContext.contextPath}/app/users/create/${bean}" method="POST" class="wizard-big">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <s:input name="username" id="username" path="username" type="text" value='${bean.username}' class="form-control required" />
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Nom *</label>
                                                        <s:input id="nom" path="nom" type="text" value='${bean.nom}' class="form-control required" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Prénom *</label>
                                                        <s:input id="prenom" path="prenom" type="text" value='${bean.prenom}' class="form-control required" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Email *</label>
                                                        <s:input id="mail" path="mail" type="text" value='${bean.mail}' class="form-control required email" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Téléphone *</label>
                                                        <s:input id="telephone" path="telephone" type="text" value='${bean.telephone}' class="form-control required" />
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Porte</label>
                                                        <s:input id="address.porte" path="address.porte" type="text" value='${bean.address.porte}' class="form-control" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Etage</label>
                                                        <s:input id="address.etage" path="address.etage" type="text" value='${bean.address.etage}' class="form-control " />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Numéro de rue *</label>
                                                        <s:input id="address.numero" path="address.numero" type="number" value='${bean.address.numero}' class="form-control required" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Rue *</label>
                                                        <s:input id="address.rue" path="address.rue" type="text" value='${bean.address.rue}' class="form-control required" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Ville *</label>
                                                        <s:input id="address.ville" path="address.ville" type="text" value='${bean.address.ville}' class="form-control required" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Code Postal *</label>
                                                        <s:input id="address.codePostal" path="address.codePostal" type="text" value='${bean.address.codePostal}' class="form-control required" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Pays *</label>
                                                        <s:input id="address.pays" path="address.pays" type="text" value='${bean.address.pays}' class="form-control required" />
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <h1>Validation</h1>
                                        <fieldset>
                                            <h2>Tèrmes & Conditions</h2>
                                            <input id="acceptTerms" name="acceptTerms" type="checkbox" class="required"> <label for="acceptTerms">J'accèpte les termes et les conditions d'utilisations</label>
                                        </fieldset>
                                    </s:form>
                                </div>
                            </div>
